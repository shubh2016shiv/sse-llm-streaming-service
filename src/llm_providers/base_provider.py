...
from src.config.constants import LLMProvider
from src.config.settings import get_settings
from src.core.execution_tracker import get_tracker
from src.core.logging import get_logger
from src.llm_providers.circuit_breaker import ResilientCall, get_circuit_breaker_manager
...
class BaseProvider(ABC):
    ...
    def get_circuit_state(self) -> str:
        ...
        return manager.get_state(self.name)
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        """
        manager = get_circuit_breaker_manager()
        cb_stats = manager.get_stats(self.name)
...
class ProviderFactory:
    ...
    def get_healthy_provider(self, exclude: list[str] | None = None) -> BaseProvider | None:
        """
